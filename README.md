...
# FastAPI project with BREAD functionality
...
# FastAPI basic calculations

a. Addition - Calculate the sum of all input values.
b. Subtraction - Implements sequential subtraction starting from the first number.
c. Multiplication - Calculate the product of all input values.
